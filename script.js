...
function showMessage(response) {
  ...
  if (response === "No") {
    ...
    document.getElementById("question").textContent =
      "Before choosing 'no', think about the vishwash that how much he loves you & surely he can't live without you";
  ...
  if (response === "Yes") {
    ...
    yesMessage.textContent = "Yay my priness just said yes, Okay ! Now please open my snap";
